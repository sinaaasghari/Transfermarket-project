...
for i in range(len(import_data)):
    ...
    url = f"https://www.transfermarkt.de/{player_name}/leistungsdatendetails/spieler/{player_id}/plus/1?saison={season_id}&verein=&liga=1&wettbewerb=&pos=&trainer_id="
    print(url)
    page = requests.get(url,headers={"User-Agent": "Chrome/112.0.5615.138",'Accept-Language': 'en-US'})
...
with open("GK.json", "w") as outfile:
